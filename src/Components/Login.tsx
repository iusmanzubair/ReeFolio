  ...
  return (
    <div className="h-[60rem] flex items-center justify-center">
      <div  className="bg-cardGray w-[32rem] p-6 rounded-xl border-[1px] border-neutral-700/50 space-y-5">
        ...
        <button onClick={signInWithGoogle} className="flex gap-2 items-center justify-center w-full bg-bgSecondary py-2.5 px-4 rounded-lg cursor-pointer"><img src={googleLogo} alt="google-log" className="w-5 h-5"/>Log in with google</button>
      </div>
    </div>
  ); 
}